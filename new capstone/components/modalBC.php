<div class="modal fade" id="R_BarangayCertificate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 fw-bold h2">Barangay Certificate</h4>
            ...
            <div class="modal-footer md-form d-flex justify-content-center requestMargin my-0">
                <button class="btn btn-dark btn-lg btn-block login" type="submit" id="request_BC" name="request_BCL">Request</button>
            </div>
            </form>
        </div>                      
    </div>
