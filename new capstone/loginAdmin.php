        ...
        <div class="col col-xl-6">
            <div class="card" style="border-radius: 1rem;">
                <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form method="POST" action="php/adminLog.php" class="align-items-center text-start" >
                    ...
                    <div class="pt-1 mb-4">
                        <button class="btn btn-dark btn-lg btn-block login" type="submit" name="loginAdmin" onclick="checkPasswordReqs()">Login</button>
                    </div>
    ...
    <div class="modal fade" id="modalSubscriptionForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-dark btn-lg btn-block login" type="submit" name="signupAdmin">Sign in</button>
            </div>
            </form>
        </div>                      
        </div>
